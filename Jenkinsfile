pipeline {
    ...
    stages {
        ...
        stage ('build/push docker image') {
            steps {
                withMaven(globalMavenSettingsConfig: 'ae44f8b3-3bf7-4624-8e87-74659f3f817f', maven: 'maven393', mavenSettingsConfig: '', traceability: true) {
                    sh "mvn deploy -DskipTests -Dmaven.install.skip=true -Dmaven.resources.skip=true -Dmaven.compile.skip=true -Dmaven.testResources.skip=true -Dmaven.testCompile.skip=true -Dmaven.test.skip=true -Dmaven.war.skip=true"
                }
